...
class CFDI(BaseModel):
    ...
    forma_pago: str = Field(..., description="Clave de forma de pago (c_FormaPago)")
    metodo_pago: str = Field(..., description="Método de pago (PUE/PPD)")
    ...
    tipo_comprobante: str = Field(..., description="Tipo (I=Ingreso, E=Egreso, T=Traslado)")
